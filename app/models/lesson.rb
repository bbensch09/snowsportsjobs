class Lesson < ActiveRecord::Base
  ...
  def price
    product = Product.where(location_id:self.requested_location.to_i,name:self.lesson_time.slot,calendar_period:self.requested_location.calendar_status).first
    if product.nil?
