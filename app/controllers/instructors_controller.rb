class InstructorsController < ApplicationController
  ...
  private
    ...
    def instructor_params
      params.require(:instructor).permit(:first_name, :last_name, :username, :preferred_locations, :certification, :phone_number, :sport, :bio, :intro, :status, :city, :user_id, :avatar, :how_did_you_hear, :confirmed_certification, :kids_eligibility, :seniors_eligibility, :adults_eligibility, :age, :dob, location_ids:[], ski_level_ids:[], snowboard_level_ids:[])
    end
end
