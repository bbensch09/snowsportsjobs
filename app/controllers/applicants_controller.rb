  ...
  def create
    ...
    respond_to do |format|
      if @applicant.save
        ...
        format.html { render 'instructors/thank_you', notice: 'Your instructor application was successfully submitted, you will be contacted shortly. You may also reach out with questions to info@snowschoolers.com' }
